...
app.layout= html.Div(children = ["COVID 19 Dashboard",
	dcc.Dropdown(id = "dropdown", options = [{'label': i, 'value': i} for i in df.continent.unique()],
		value = "Asia", style = {'fontSize': 15}),
	dcc.Graph(id = "covid_graph")],
	style = {'family': 'Verdana', 'backgroundColor': '#cfe3ff',
			"fontSize": 40})
...
def update_graph(continent):
	...
	fig = px.bar(x = data['country'], y = data['death_total'], title = "Coronavirus Deaths By Continent",
